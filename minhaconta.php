...
try {
    ...
    echo "Erro ao encontrar aluno: " . $e->getMessage();
}
?>
  ...
  <div class="container-custom">
    <div class="row">
      <div class="col-md-6 info-container" style="margin: 4em 2em 0em;">
        ...
        <hr>
        <div>
        <a href="alterarsenha.php" type="submit" class="btn btn-primary btn-block" style="background-color: lightpink; border: none;">Alterar Senha</a>
        <a href="excluirusuario.php?email=<?php echo urlencode($email); ?>" type="submit" class="btn btn-primary btn-block" style="background-color: #ea616c; border: none;">Excluir Conta</a>
        </div>
      </div>
      <div class="col-md-6 img-container">
        <img src="imagem/minhaconta.png" alt="Dois gatinhos">
      </div>
    </div>
  </div>
</div>
